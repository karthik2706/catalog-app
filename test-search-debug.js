...
async function testSearchDebug() {
  try {
    ...
    console.log('Login successful, token length:', loginData.token ? loginData.token.length : 0);
    ...
    console.log('Step 2: Testing search by image with detailed logging...');
    ...
    console.log('Created test image, size:', testImageBuffer.length);
