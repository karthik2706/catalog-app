...
import GuestCartClient from './GuestCartClient'
...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: client ? `Shopping Cart - ${client.name}` : 'Shopping Cart',
    description: 'Review your items before checkout',
  }
}

export default async function GuestCartPage({ params }: PageProps) {
  const { slug } = await params
