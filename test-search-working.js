...
async function testSearchWorking() {
  try {
    ...
    console.log('Step 2: Testing search by image with working 1x1 PNG...');
    
    // Create a working 1x1 PNG
    ...
    console.log('Using 1x1 PNG, size:', testImageBuffer.length);

    // Create form data using native FormData (Node.js 18+)
    const formData = new FormData();
    const file = new File([testImageBuffer], 'test-1x1.png', { type: 'image/png' });
